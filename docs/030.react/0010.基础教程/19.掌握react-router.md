---
title: 19-掌握react-router
date: 2023-02-07 18:25:44
permalink: /pages/c334e9/
categories:
  - react
tags:
  - 
...
![图片](./assets/640-1639398351623.jpeg)
...
![图片](./assets/640-1639399954423.jpeg)
...
![图片](./assets/640-1639400006780.jpeg)

原因是什么呢？默认情况下，`react-router`中只要是路径被匹配到的Route对应的组件都会被渲染；
...
- 但是在User界面有一个`isLogin`用于记录用户是否登录：
...
- Detail2中是需要在`location`中获取`search`的；
...
![图片](./assets/640-1639749557360.jpeg)
